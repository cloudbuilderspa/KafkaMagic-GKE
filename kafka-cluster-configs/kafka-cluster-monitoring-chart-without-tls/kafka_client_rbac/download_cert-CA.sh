...
kubectl get secret my-user -n strimzi-platform -o jsonpath='{.data}'
...
kubectl get secret my-user -n strimzi-platform -o jsonpath='{.data.user\.key}' | base64 --decode > user.key
kubectl get secret my-user -n strimzi-platform -o jsonpath='{.data.user\.p12}' | base64 --decode > user.p12
kubectl get secret my-user -n strimzi-platform -o jsonpath='{.data.user\.password}' | base64 --decode > user.password
