...
kubectl get secret strimzi-platform-my-cluster-dev-cluster-ca-cert -n strimzi-platform -o jsonpath='{.data}'
kubectl get secret kafka-exporter-user -n strimzi-platform -o jsonpath='{.data}'
...
kubectl get secret kafka-exporter-user -n strimzi-platform -o jsonpath='{.data.user\.crt}' | base64 --decode > user.crt
kubectl get secret kafka-exporter-user -n strimzi-platform -o jsonpath='{.data.user\.key}' | base64 --decode > user.key
kubectl get secret kafka-exporter-user -n strimzi-platform -o jsonpath='{.data.user\.p12}' | base64 --decode > user.p12
kubectl get secret kafka-exporter-user -n strimzi-platform -o jsonpath='{.data.user\.password}' | base64 --decode > user.password
